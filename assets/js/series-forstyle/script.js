        ...
        photoSlider.addEventListener('click', function(e) {
            ...
            if (target && target.classList && target.classList.contains('js-top__photo-slider-item')) {
                if (target.classList.contains('clicked')) {
                    ...
                    photoSlider.querySelectorAll('.js-top__photo-slider-item.clicked').forEach(el => el.classList.remove('clicked'));
...
(function () {
    ...
    function isNewsOpen() {
        ...
        return wrap && wrap.style.display !== 'none' && (wrap.style.maxHeight === 'none' || wrap.style.maxHeight === '');
    }
...
function switchVideo(targetPlayer) {
    ...
    if((playerPosition < startPosition) && (playerPosition > endPosition)) {
        ...
        if (ytPlayerInstance && ytPlayerInstance.getPlayerState && ytPlayerInstance.getPlayerState() === 1) { // 1 = PLAYING
            pausedByScroll = true;
